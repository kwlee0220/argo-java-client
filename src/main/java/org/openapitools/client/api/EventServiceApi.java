...
public class EventServiceApi {
     ...
     */
    public okhttp3.Call eventServiceListWorkflowEventBindingsAsync(String namespace, String listOptionsLabelSelector, String listOptionsFieldSelector, Boolean listOptionsWatch, Boolean listOptionsAllowWatchBookmarks, String listOptionsResourceVersion, String listOptionsResourceVersionMatch, String listOptionsTimeoutSeconds, String listOptionsLimit, String listOptionsContinue, Boolean listOptionsSendInitialEvents, final ApiCallback<IoArgoprojWorkflowV1alpha1WorkflowEventBindingList> _callback) throws ApiException {
    ...
    public okhttp3.Call eventServiceReceiveEventCall(String namespace, String discriminator, Object body, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/v1/events/{namespace}/{discriminator}"
            .replace("{" + "namespace" + "}", localVarApiClient.escapeString(namespace.toString()))
            .replace("{" + "discriminator" + "}", localVarApiClient.escapeString(discriminator.toString()));
    ...
    private okhttp3.Call eventServiceReceiveEventValidateBeforeCall(String namespace, String discriminator, Object body, final ApiCallback _callback) throws ApiException {
        ...
        return eventServiceReceiveEventCall(namespace, discriminator, body, _callback);
