...
public class IoArgoprojWorkflowV1alpha1OSSArtifactRepository {
  ...
  public IoArgoprojWorkflowV1alpha1OSSArtifactRepository accessKeySecret(@javax.annotation.Nullable IoK8sApiCoreV1SecretKeySelector accessKeySecret) {
  ...
  public IoArgoprojWorkflowV1alpha1OSSArtifactRepository bucket(@javax.annotation.Nullable String bucket) {
    this.bucket = bucket;
    return this;
  }
  ...
  public IoArgoprojWorkflowV1alpha1OSSArtifactRepository createBucketIfNotPresent(@javax.annotation.Nullable Boolean createBucketIfNotPresent) {
  ...
  public IoArgoprojWorkflowV1alpha1OSSArtifactRepository endpoint(@javax.annotation.Nullable String endpoint) {
  ...
  public IoArgoprojWorkflowV1alpha1OSSArtifactRepository keyFormat(@javax.annotation.Nullable String keyFormat) {
  ...
  public IoArgoprojWorkflowV1alpha1OSSArtifactRepository lifecycleRule(@javax.annotation.Nullable IoArgoprojWorkflowV1alpha1OSSLifecycleRule lifecycleRule) {
  ...
  public IoArgoprojWorkflowV1alpha1OSSArtifactRepository secretKeySecret(@javax.annotation.Nullable IoK8sApiCoreV1SecretKeySelector secretKeySecret) {
  ...
  public IoArgoprojWorkflowV1alpha1OSSArtifactRepository securityToken(@javax.annotation.Nullable String securityToken) {
  ...
  public IoArgoprojWorkflowV1alpha1OSSArtifactRepository useSDKCreds(@javax.annotation.Nullable Boolean useSDKCreds) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessKeySecret, ioArgoprojWorkflowV1alpha1OSSArtifactRepository.accessKeySecret) &&
        ...
        Objects.equals(this.useSDKCreds, ioArgoprojWorkflowV1alpha1OSSArtifactRepository.useSDKCreds);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to IoArgoprojWorkflowV1alpha1OSSArtifactRepository
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IoArgoprojWorkflowV1alpha1OSSArtifactRepository.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IoArgoprojWorkflowV1alpha1OSSArtifactRepository is not found in the empty JSON string", IoArgoprojWorkflowV1alpha1OSSArtifactRepository.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IoArgoprojWorkflowV1alpha1OSSArtifactRepository.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IoArgoprojWorkflowV1alpha1OSSArtifactRepository` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IoArgoprojWorkflowV1alpha1OSSArtifactRepository.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IoArgoprojWorkflowV1alpha1OSSArtifactRepository' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IoArgoprojWorkflowV1alpha1OSSArtifactRepository> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IoArgoprojWorkflowV1alpha1OSSArtifactRepository.class));

       return (TypeAdapter<T>) new TypeAdapter<IoArgoprojWorkflowV1alpha1OSSArtifactRepository>() {
           @Override
           public void write(JsonWriter out, IoArgoprojWorkflowV1alpha1OSSArtifactRepository value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IoArgoprojWorkflowV1alpha1OSSArtifactRepository read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IoArgoprojWorkflowV1alpha1OSSArtifactRepository given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IoArgoprojWorkflowV1alpha1OSSArtifactRepository
   * @throws IOException if the JSON string is invalid with respect to IoArgoprojWorkflowV1alpha1OSSArtifactRepository
   */
  public static IoArgoprojWorkflowV1alpha1OSSArtifactRepository fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IoArgoprojWorkflowV1alpha1OSSArtifactRepository.class);
  }

  /**
   * Convert an instance of IoArgoprojWorkflowV1alpha1OSSArtifactRepository to an JSON string
   *
   * @return JSON string
   */
