...
public class IoK8sApiCoreV1Container {
  ...
  public IoK8sApiCoreV1Container args(@javax.annotation.Nullable List<String> args) {
    this.args = args;
    return this;
  }
  ...
  public IoK8sApiCoreV1Container command(@javax.annotation.Nullable List<String> command) {
  ...
  public IoK8sApiCoreV1Container env(@javax.annotation.Nullable List<IoK8sApiCoreV1EnvVar> env) {
    this.env = env;
    return this;
  }
  ...
  public IoK8sApiCoreV1Container envFrom(@javax.annotation.Nullable List<IoK8sApiCoreV1EnvFromSource> envFrom) {
  ...
  public IoK8sApiCoreV1Container image(@javax.annotation.Nonnull String image) {
    this.image = image;
    return this;
  }
  ...
  public IoK8sApiCoreV1Container imagePullPolicy(@javax.annotation.Nullable String imagePullPolicy) {
  ...
  public IoK8sApiCoreV1Container lifecycle(@javax.annotation.Nullable IoK8sApiCoreV1Lifecycle lifecycle) {
  ...
  public IoK8sApiCoreV1Container livenessProbe(@javax.annotation.Nullable IoK8sApiCoreV1Probe livenessProbe) {
  ...
  public IoK8sApiCoreV1Container name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public IoK8sApiCoreV1Container ports(@javax.annotation.Nullable List<IoK8sApiCoreV1ContainerPort> ports) {
    this.ports = ports;
    return this;
  }
  ...
  public IoK8sApiCoreV1Container readinessProbe(@javax.annotation.Nullable IoK8sApiCoreV1Probe readinessProbe) {
  ...
  public IoK8sApiCoreV1Container resizePolicy(@javax.annotation.Nullable List<IoK8sApiCoreV1ContainerResizePolicy> resizePolicy) {
    this.resizePolicy = resizePolicy;
    return this;
  }

  public IoK8sApiCoreV1Container addResizePolicyItem(IoK8sApiCoreV1ContainerResizePolicy resizePolicyItem) {
  ...
  public IoK8sApiCoreV1Container resources(@javax.annotation.Nullable IoK8sApiCoreV1ResourceRequirements resources) {
  ...
  public IoK8sApiCoreV1Container restartPolicy(@javax.annotation.Nullable String restartPolicy) {
  ...
  public IoK8sApiCoreV1Container securityContext(@javax.annotation.Nullable IoK8sApiCoreV1SecurityContext securityContext) {
  ...
  public IoK8sApiCoreV1Container startupProbe(@javax.annotation.Nullable IoK8sApiCoreV1Probe startupProbe) {
  ...
  public IoK8sApiCoreV1Container stdin(@javax.annotation.Nullable Boolean stdin) {
    this.stdin = stdin;
    return this;
  }
  ...
  public IoK8sApiCoreV1Container stdinOnce(@javax.annotation.Nullable Boolean stdinOnce) {
  ...
  public IoK8sApiCoreV1Container terminationMessagePath(@javax.annotation.Nullable String terminationMessagePath) {
  ...
  public IoK8sApiCoreV1Container terminationMessagePolicy(@javax.annotation.Nullable String terminationMessagePolicy) {
  ...
  public IoK8sApiCoreV1Container tty(@javax.annotation.Nullable Boolean tty) {
    this.tty = tty;
    return this;
  }
  ...
  public IoK8sApiCoreV1Container volumeDevices(@javax.annotation.Nullable List<IoK8sApiCoreV1VolumeDevice> volumeDevices) {
  ...
  public IoK8sApiCoreV1Container volumeMounts(@javax.annotation.Nullable List<IoK8sApiCoreV1VolumeMount> volumeMounts) {
  ...
  public IoK8sApiCoreV1Container workingDir(@javax.annotation.Nullable String workingDir) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.args, ioK8sApiCoreV1Container.args) &&
        ...
        Objects.equals(this.resizePolicy, ioK8sApiCoreV1Container.resizePolicy) &&
        Objects.equals(this.resources, ioK8sApiCoreV1Container.resources) &&
        Objects.equals(this.restartPolicy, ioK8sApiCoreV1Container.restartPolicy) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to IoK8sApiCoreV1Container
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IoK8sApiCoreV1Container.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IoK8sApiCoreV1Container is not found in the empty JSON string", IoK8sApiCoreV1Container.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IoK8sApiCoreV1Container.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IoK8sApiCoreV1Container` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IoK8sApiCoreV1Container.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IoK8sApiCoreV1Container.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IoK8sApiCoreV1Container' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IoK8sApiCoreV1Container> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IoK8sApiCoreV1Container.class));

       return (TypeAdapter<T>) new TypeAdapter<IoK8sApiCoreV1Container>() {
           @Override
           public void write(JsonWriter out, IoK8sApiCoreV1Container value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IoK8sApiCoreV1Container read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IoK8sApiCoreV1Container given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IoK8sApiCoreV1Container
   * @throws IOException if the JSON string is invalid with respect to IoK8sApiCoreV1Container
   */
  public static IoK8sApiCoreV1Container fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IoK8sApiCoreV1Container.class);
  }

  /**
   * Convert an instance of IoK8sApiCoreV1Container to an JSON string
   *
   * @return JSON string
   */
