...
public class IoArgoprojWorkflowV1alpha1ArtifactPaths {
  ...
  public IoArgoprojWorkflowV1alpha1ArtifactPaths() {
  }

  public IoArgoprojWorkflowV1alpha1ArtifactPaths archive(@javax.annotation.Nullable IoArgoprojWorkflowV1alpha1ArchiveStrategy archive) {
  ...
  public IoArgoprojWorkflowV1alpha1ArtifactPaths archiveLogs(@javax.annotation.Nullable Boolean archiveLogs) {
  ...
  public IoArgoprojWorkflowV1alpha1ArtifactPaths artifactGC(@javax.annotation.Nullable IoArgoprojWorkflowV1alpha1ArtifactGC artifactGC) {
  ...
  public IoArgoprojWorkflowV1alpha1ArtifactPaths artifactory(@javax.annotation.Nullable IoArgoprojWorkflowV1alpha1ArtifactoryArtifact artifactory) {
  ...
  public IoArgoprojWorkflowV1alpha1ArtifactPaths azure(@javax.annotation.Nullable IoArgoprojWorkflowV1alpha1AzureArtifact azure) {
    this.azure = azure;
    return this;
  }
  ...
  public IoArgoprojWorkflowV1alpha1ArtifactPaths deleted(@javax.annotation.Nullable Boolean deleted) {
  ...
  public IoArgoprojWorkflowV1alpha1ArtifactPaths from(@javax.annotation.Nullable String from) {
    this.from = from;
    return this;
  }
  ...
  public IoArgoprojWorkflowV1alpha1ArtifactPaths fromExpression(@javax.annotation.Nullable String fromExpression) {
  ...
  public IoArgoprojWorkflowV1alpha1ArtifactPaths gcs(@javax.annotation.Nullable IoArgoprojWorkflowV1alpha1GCSArtifact gcs) {
    this.gcs = gcs;
    return this;
  }
  ...
  public IoArgoprojWorkflowV1alpha1ArtifactPaths git(@javax.annotation.Nullable IoArgoprojWorkflowV1alpha1GitArtifact git) {
    this.git = git;
    return this;
  }
  ...
  public IoArgoprojWorkflowV1alpha1ArtifactPaths globalName(@javax.annotation.Nullable String globalName) {
  ...
  public IoArgoprojWorkflowV1alpha1ArtifactPaths hdfs(@javax.annotation.Nullable IoArgoprojWorkflowV1alpha1HDFSArtifact hdfs) {
    this.hdfs = hdfs;
    return this;
  }
  ...
  public IoArgoprojWorkflowV1alpha1ArtifactPaths http(@javax.annotation.Nullable IoArgoprojWorkflowV1alpha1HTTPArtifact http) {
    this.http = http;
    return this;
  }
  ...
  public IoArgoprojWorkflowV1alpha1ArtifactPaths mode(@javax.annotation.Nullable Integer mode) {
    this.mode = mode;
    return this;
  }
  ...
  public IoArgoprojWorkflowV1alpha1ArtifactPaths name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public IoArgoprojWorkflowV1alpha1ArtifactPaths optional(@javax.annotation.Nullable Boolean optional) {
  ...
  public IoArgoprojWorkflowV1alpha1ArtifactPaths oss(@javax.annotation.Nullable IoArgoprojWorkflowV1alpha1OSSArtifact oss) {
    this.oss = oss;
    return this;
  }
  ...
  public IoArgoprojWorkflowV1alpha1ArtifactPaths path(@javax.annotation.Nullable String path) {
    this.path = path;
    return this;
  }
  ...
  public IoArgoprojWorkflowV1alpha1ArtifactPaths raw(@javax.annotation.Nullable IoArgoprojWorkflowV1alpha1RawArtifact raw) {
    this.raw = raw;
    return this;
  }
  ...
  public IoArgoprojWorkflowV1alpha1ArtifactPaths recurseMode(@javax.annotation.Nullable Boolean recurseMode) {
  ...
  public IoArgoprojWorkflowV1alpha1ArtifactPaths s3(@javax.annotation.Nullable IoArgoprojWorkflowV1alpha1S3Artifact s3) {
    this.s3 = s3;
    return this;
  }
  ...
  public IoArgoprojWorkflowV1alpha1ArtifactPaths subPath(@javax.annotation.Nullable String subPath) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to IoArgoprojWorkflowV1alpha1ArtifactPaths
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IoArgoprojWorkflowV1alpha1ArtifactPaths.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IoArgoprojWorkflowV1alpha1ArtifactPaths is not found in the empty JSON string", IoArgoprojWorkflowV1alpha1ArtifactPaths.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IoArgoprojWorkflowV1alpha1ArtifactPaths.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IoArgoprojWorkflowV1alpha1ArtifactPaths` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IoArgoprojWorkflowV1alpha1ArtifactPaths.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IoArgoprojWorkflowV1alpha1ArtifactPaths.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IoArgoprojWorkflowV1alpha1ArtifactPaths' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IoArgoprojWorkflowV1alpha1ArtifactPaths> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IoArgoprojWorkflowV1alpha1ArtifactPaths.class));

       return (TypeAdapter<T>) new TypeAdapter<IoArgoprojWorkflowV1alpha1ArtifactPaths>() {
           @Override
           public void write(JsonWriter out, IoArgoprojWorkflowV1alpha1ArtifactPaths value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IoArgoprojWorkflowV1alpha1ArtifactPaths read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IoArgoprojWorkflowV1alpha1ArtifactPaths given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IoArgoprojWorkflowV1alpha1ArtifactPaths
   * @throws IOException if the JSON string is invalid with respect to IoArgoprojWorkflowV1alpha1ArtifactPaths
   */
  public static IoArgoprojWorkflowV1alpha1ArtifactPaths fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IoArgoprojWorkflowV1alpha1ArtifactPaths.class);
  }

  /**
   * Convert an instance of IoArgoprojWorkflowV1alpha1ArtifactPaths to an JSON string
   *
   * @return JSON string
   */
