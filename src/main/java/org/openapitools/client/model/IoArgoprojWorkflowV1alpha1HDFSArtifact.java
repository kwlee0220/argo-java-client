...
public class IoArgoprojWorkflowV1alpha1HDFSArtifact {
  ...
  public IoArgoprojWorkflowV1alpha1HDFSArtifact() {
  }

  public IoArgoprojWorkflowV1alpha1HDFSArtifact addresses(@javax.annotation.Nullable List<String> addresses) {
  ...
  public IoArgoprojWorkflowV1alpha1HDFSArtifact dataTransferProtection(@javax.annotation.Nullable String dataTransferProtection) {
  ...
  public IoArgoprojWorkflowV1alpha1HDFSArtifact force(@javax.annotation.Nullable Boolean force) {
    this.force = force;
    return this;
  }
  ...
  public IoArgoprojWorkflowV1alpha1HDFSArtifact hdfsUser(@javax.annotation.Nullable String hdfsUser) {
  ...
  public IoArgoprojWorkflowV1alpha1HDFSArtifact krbCCacheSecret(@javax.annotation.Nullable IoK8sApiCoreV1SecretKeySelector krbCCacheSecret) {
  ...
  public IoArgoprojWorkflowV1alpha1HDFSArtifact krbConfigConfigMap(@javax.annotation.Nullable IoK8sApiCoreV1ConfigMapKeySelector krbConfigConfigMap) {
  ...
  public IoArgoprojWorkflowV1alpha1HDFSArtifact krbKeytabSecret(@javax.annotation.Nullable IoK8sApiCoreV1SecretKeySelector krbKeytabSecret) {
  ...
  public IoArgoprojWorkflowV1alpha1HDFSArtifact krbRealm(@javax.annotation.Nullable String krbRealm) {
  ...
  public IoArgoprojWorkflowV1alpha1HDFSArtifact krbServicePrincipalName(@javax.annotation.Nullable String krbServicePrincipalName) {
  ...
  public IoArgoprojWorkflowV1alpha1HDFSArtifact krbUsername(@javax.annotation.Nullable String krbUsername) {
  ...
  public IoArgoprojWorkflowV1alpha1HDFSArtifact path(@javax.annotation.Nonnull String path) {
    this.path = path;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.addresses, ioArgoprojWorkflowV1alpha1HDFSArtifact.addresses) &&
        Objects.equals(this.dataTransferProtection, ioArgoprojWorkflowV1alpha1HDFSArtifact.dataTransferProtection) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(addresses, dataTransferProtection, force, hdfsUser, krbCCacheSecret, krbConfigConfigMap, krbKeytabSecret, krbRealm, krbServicePrincipalName, krbUsername, path);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to IoArgoprojWorkflowV1alpha1HDFSArtifact
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IoArgoprojWorkflowV1alpha1HDFSArtifact.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IoArgoprojWorkflowV1alpha1HDFSArtifact is not found in the empty JSON string", IoArgoprojWorkflowV1alpha1HDFSArtifact.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IoArgoprojWorkflowV1alpha1HDFSArtifact.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IoArgoprojWorkflowV1alpha1HDFSArtifact` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IoArgoprojWorkflowV1alpha1HDFSArtifact.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IoArgoprojWorkflowV1alpha1HDFSArtifact.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IoArgoprojWorkflowV1alpha1HDFSArtifact' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IoArgoprojWorkflowV1alpha1HDFSArtifact> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IoArgoprojWorkflowV1alpha1HDFSArtifact.class));

       return (TypeAdapter<T>) new TypeAdapter<IoArgoprojWorkflowV1alpha1HDFSArtifact>() {
           @Override
           public void write(JsonWriter out, IoArgoprojWorkflowV1alpha1HDFSArtifact value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IoArgoprojWorkflowV1alpha1HDFSArtifact read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IoArgoprojWorkflowV1alpha1HDFSArtifact given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IoArgoprojWorkflowV1alpha1HDFSArtifact
   * @throws IOException if the JSON string is invalid with respect to IoArgoprojWorkflowV1alpha1HDFSArtifact
   */
  public static IoArgoprojWorkflowV1alpha1HDFSArtifact fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IoArgoprojWorkflowV1alpha1HDFSArtifact.class);
  }

  /**
   * Convert an instance of IoArgoprojWorkflowV1alpha1HDFSArtifact to an JSON string
   *
   * @return JSON string
   */
