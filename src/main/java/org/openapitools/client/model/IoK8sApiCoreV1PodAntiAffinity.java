...
public class IoK8sApiCoreV1PodAntiAffinity {
  ...
  public IoK8sApiCoreV1PodAntiAffinity preferredDuringSchedulingIgnoredDuringExecution(@javax.annotation.Nullable List<IoK8sApiCoreV1WeightedPodAffinityTerm> preferredDuringSchedulingIgnoredDuringExecution) {
  ...
  public IoK8sApiCoreV1PodAntiAffinity requiredDuringSchedulingIgnoredDuringExecution(@javax.annotation.Nullable List<IoK8sApiCoreV1PodAffinityTerm> requiredDuringSchedulingIgnoredDuringExecution) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to IoK8sApiCoreV1PodAntiAffinity
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IoK8sApiCoreV1PodAntiAffinity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IoK8sApiCoreV1PodAntiAffinity is not found in the empty JSON string", IoK8sApiCoreV1PodAntiAffinity.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IoK8sApiCoreV1PodAntiAffinity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IoK8sApiCoreV1PodAntiAffinity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IoK8sApiCoreV1PodAntiAffinity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IoK8sApiCoreV1PodAntiAffinity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IoK8sApiCoreV1PodAntiAffinity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IoK8sApiCoreV1PodAntiAffinity.class));

       return (TypeAdapter<T>) new TypeAdapter<IoK8sApiCoreV1PodAntiAffinity>() {
           @Override
           public void write(JsonWriter out, IoK8sApiCoreV1PodAntiAffinity value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IoK8sApiCoreV1PodAntiAffinity read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IoK8sApiCoreV1PodAntiAffinity given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IoK8sApiCoreV1PodAntiAffinity
   * @throws IOException if the JSON string is invalid with respect to IoK8sApiCoreV1PodAntiAffinity
   */
  public static IoK8sApiCoreV1PodAntiAffinity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IoK8sApiCoreV1PodAntiAffinity.class);
  }

  /**
   * Convert an instance of IoK8sApiCoreV1PodAntiAffinity to an JSON string
   *
   * @return JSON string
   */
