...
public class IoK8sApiCoreV1RBDVolumeSource {
  ...
  public IoK8sApiCoreV1RBDVolumeSource fsType(@javax.annotation.Nullable String fsType) {
    this.fsType = fsType;
    return this;
  }
  ...
  public IoK8sApiCoreV1RBDVolumeSource image(@javax.annotation.Nonnull String image) {
    this.image = image;
    return this;
  }
  ...
  public IoK8sApiCoreV1RBDVolumeSource keyring(@javax.annotation.Nullable String keyring) {
  ...
  public void setKeyring(@javax.annotation.Nullable String keyring) {
    this.keyring = keyring;
  }


  public IoK8sApiCoreV1RBDVolumeSource monitors(@javax.annotation.Nonnull List<String> monitors) {
  ...
  public void setMonitors(@javax.annotation.Nonnull List<String> monitors) {
    this.monitors = monitors;
  }


  public IoK8sApiCoreV1RBDVolumeSource pool(@javax.annotation.Nullable String pool) {
    this.pool = pool;
    return this;
  }
  ...
  public IoK8sApiCoreV1RBDVolumeSource readOnly(@javax.annotation.Nullable Boolean readOnly) {
  ...
  public IoK8sApiCoreV1RBDVolumeSource secretRef(@javax.annotation.Nullable IoK8sApiCoreV1LocalObjectReference secretRef) {
  ...
  public IoK8sApiCoreV1RBDVolumeSource user(@javax.annotation.Nullable String user) {
    this.user = user;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to IoK8sApiCoreV1RBDVolumeSource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IoK8sApiCoreV1RBDVolumeSource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IoK8sApiCoreV1RBDVolumeSource is not found in the empty JSON string", IoK8sApiCoreV1RBDVolumeSource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IoK8sApiCoreV1RBDVolumeSource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IoK8sApiCoreV1RBDVolumeSource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IoK8sApiCoreV1RBDVolumeSource.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IoK8sApiCoreV1RBDVolumeSource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IoK8sApiCoreV1RBDVolumeSource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IoK8sApiCoreV1RBDVolumeSource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IoK8sApiCoreV1RBDVolumeSource.class));

       return (TypeAdapter<T>) new TypeAdapter<IoK8sApiCoreV1RBDVolumeSource>() {
           @Override
           public void write(JsonWriter out, IoK8sApiCoreV1RBDVolumeSource value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IoK8sApiCoreV1RBDVolumeSource read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IoK8sApiCoreV1RBDVolumeSource given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IoK8sApiCoreV1RBDVolumeSource
   * @throws IOException if the JSON string is invalid with respect to IoK8sApiCoreV1RBDVolumeSource
   */
  public static IoK8sApiCoreV1RBDVolumeSource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IoK8sApiCoreV1RBDVolumeSource.class);
  }

  /**
   * Convert an instance of IoK8sApiCoreV1RBDVolumeSource to an JSON string
   *
   * @return JSON string
   */
