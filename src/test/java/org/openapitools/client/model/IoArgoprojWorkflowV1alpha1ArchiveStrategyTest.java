 ...
 */
public class IoArgoprojWorkflowV1alpha1ArchiveStrategyTest {
    private final IoArgoprojWorkflowV1alpha1ArchiveStrategy model = new IoArgoprojWorkflowV1alpha1ArchiveStrategy();
